   ...
   <footer id="page-footer">
        <div class="inner">
            ...
            <aside id="footer-copyright">
                <div class="container">
                    <span>Copyright © 2016-2019	aiuiot.</span>
            ...
            <div class="container">
                ...
                <div class="user-area">
                    ...
                    <div class="language-bar">
                        <a href="#" class="active">
                            <img src="/static/assets/img/flags/gb.png" alt="">
                        </a>
                        <a href="#">
                            <img src="/static/assets/img/flags/de.png" alt="">
                        </a>
                        <a href="#">
                            <img src="/static/assets/img/flags/es.png" alt="">
                        </a>
                    </div>
                </div>
            </div>
