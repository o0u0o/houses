                                ...
                                <#if loginUser??>
                                    <span class="actions">
                                        ...
                                        <a href="#" class="bookmark" data-bookmark-state="empty">
                                            <span class="title-add">添加收藏</span>
                                            <span class="title-added">已收藏</span>
                                        </a>
                                    </span>
                               </#if>
                            <#--     如果用户登录 显示收藏-end    -->
                                ...
                                <section id="quick-summary" class="clearfix">
                                    ...
                                    <dl>
                                        <dt>地址</dt>
                                            <dd>${house.address}</dd>
                                        <dt>价格</dt>
                                            <dd><span class="tag price">${house.price}万元</span></dd>
                                        <dt>类型:</dt>
                                            <dd>销售</dd>
                                        <dt>面积:</dt>
                                    ...
                                    <div class="floor-plans">
                                        <header>
                                         ...
                                         <#list house.floorPlanList as floorPlan>
                                            <a href="${floorPlan}" class="image-popup">
                                                <img alt="" src="${floorPlan}">
                                            </a>
                                         </#list>
                                    </div>
                                </section><!-- /#floor-plans -->
...
<#--                                                    <span class="fa fa-calendar"></span>${(comment.createTime)?datetime}</span>-->
<#--                                                <p>${comment.content}-->
<#--                                                </p>-->
<#--                                                <hr>-->
<#--                                            </div>-->
