                ...
                <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                    ...
                    <form role="form" id="form-create-account" method="post" enctype="multipart/form-data" action="/accounts/register">
                        ...
                        <div class="form-group">
                            ...
                            <input id="file-upload" type="file" class="file" multiple="true" data-show-upload="false" data-show-caption="false" data-show-remove="false" accept="image/jpeg,image/png" data-browse-class="btn btn-default" data-browse-label="上传图片" name="avatarFile" required>
                            <figure class="note"><strong>提示:</strong> 你可以一次上传所有的图片!</figure>
                        </div>
